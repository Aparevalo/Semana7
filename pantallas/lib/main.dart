...
import 'package:pantallas/vista/pantallaA.dart';
import 'package:pantallas/vista/pantallaB.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(counterModel: counterModel, updateCallback: _updateCounter),
    );
  }
